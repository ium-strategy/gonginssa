...
window.GI_CONFIG = {
  ...
  // 해시태그 사전 — 고정 어휘 10개(261011: 노션에서 발행한 아티클 7편이 쓴
  // '홍보'·'보고서' 태그가 이 사전에 없어 주제 클라우드에서 조용히 빠지고
  // 있던 걸 발견해 추가함. 원래 새 태그 추가는 분기 단위로 검토하는 항목이라
  // 이번처럼 급하게 늘린 건 예외 — 다음 분기 검토 때 정리 여부 재확인 필요.
  // 격주 1편 발행 구조에서 태그를 늘리면 태그당 1편짜리가 양산된다.
  tagDictionary: ["SNS", "캠페인", "공모전", "보도자료", "영상", "데이터", "저작권", "AI", "홍보", "보고서"],
